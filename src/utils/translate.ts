const translate = {
  EN: {
    ...
    projects: {
      ...
      kasa: "Kasa is a property rental web application. This project is entirely developed on React and all the management of events is done without librarys. The mockups to be integrated were created by a UI designer with the Figma design tool.",
      hottakes:
  ...
  FR: {
    ...
    projects: {
      ...
      kasa: "Kasa est une application web de location immobilière. Ce projet est entièrement développer avec React est la gestion des évenements est faite sans librairie. Les maquettes à intégrer ont été réalisées par un designer UI depuis l'outil de design Figma.",
      hottakes:
